...
public class YkneoOath extends Applet {
	...
	public void process(APDU apdu) {
		...
		case DELETE_INS: // delete 0x02
			...
			break;
		case SET_CODE_INS: // set code 0x03
			if(p1p2 == 0x0000) {
		...
		case LIST_INS: // list 0xa1
			...
			break;
		case CALCULATE_INS: // calculate 0xa2
			...
			break;
		case VALIDATE_INS: // validate code 0xa3
			if(p1p2 == 0x0000) {
			...
			break;
		case CALCULATE_ALL_INS: // calculate all codes 0xa4
			if(p1 == 0x00 && (p2 == 0x00 || p2 == 0x01)) {
			...
			break;
		case SEND_REMAINING_INS: // send data remaining in send buffer 0xa5
